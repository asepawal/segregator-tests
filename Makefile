...
APP_SOURCE_DIR	= freertos/Demo/Common

APP_SRC =  \
	$(APP_SOURCE_DIR)/Minimal/blocktim.c \
	$(APP_SOURCE_DIR)/Minimal/countsem.c \
	$(APP_SOURCE_DIR)/Minimal/recmutex.c
